...
|                                                    |
|     This was a modified version of the Rustlings   |
|     course for you to test your Rust knowledge     |
|     before applying to the Polkadot Academy. If    |
|     If you've come this far, you probably know     |
|     enough basic Rust to be ready for the course.  |
+--------------------------  ------------------------+
                          \\/
     ▒▒          ▒▒▒▒▒▒▒▒      ▒▒▒▒▒▒▒▒          ▒▒
   ▒▒▒▒  ▒▒    ▒▒        ▒▒  ▒▒        ▒▒    ▒▒  ▒▒▒▒
